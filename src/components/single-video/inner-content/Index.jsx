																...
																<ul className='list-unstyled list-inline'>
																	<li>
																		{currentVideo != null && currentVideo.status == false ? (
																			<Link to="#" onClick={() => this.addToFavourite(currentVideo.playVideo._id, true)}>
																				<img src={AddToFav} alt='' />
																			</Link>
																		) : (
																				<Link to="#" onClick={() => this.addToFavourite(currentVideo.playVideo._id, false)}>
																	...
																	<li>
																		{currentVideo != null && currentVideo.playVideo != null ? (
																			<Link to="#" onClick={() => this.watchLater(currentVideo.playVideo._id, true)}>
																				<img src={WatchList} alt='' />
																			</Link>
																		) : (
																				<Link to="#" onClick={() => this.watchLater(currentVideo.playVideo._id, false)}>
																					<img src={WatchList} alt='' />
																				</Link>
																			)}
																	</li>
